...
<body>
    <nav>
        ...
        <ul>
            ...
            <li><a clas="active" href="form.php">Formulário</a></li>
    ...
    $dados = mysqli_query($con, "SELECT * FROM pessoa WHERE rg = '$rg'");
    $arrayDados = mysqli_fetch_array($dados);
    
    ?>
    <div class="wrapper">
        <div class="form">
            <form name="formulario" action="update.php?id='<?php echo $rg?>'" method="post">
                <h2>Alterar Dados de <?php echo $arrayDados[1]?></h2>
                <div class="form1">
                    <label>RG:</label>
                    <input type="text" name="rg" class="input" value="<?php echo $arrayDados[0] ?>" disabled>
